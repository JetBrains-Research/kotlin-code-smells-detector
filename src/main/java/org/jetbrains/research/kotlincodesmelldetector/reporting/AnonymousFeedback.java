package org.jetbrains.research.kotlincodesmelldetector.reporting;
...
import static org.jetbrains.research.kotlincodesmelldetector.reporting.InformationType.*;
...
class AnonymousFeedback {
    ...
    static SubmittedReportInfo sendFeedback(ErrorReportInformation errorReportInformation) {
        ...
        try {
            ...
            final String message = KotlinCodeSmellDetectorBundle.message(isNewIssue ? "git.issue.text" : "git.issue.duplicate.text", htmlUrl, id);
            ...
            return new SubmittedReportInfo(HTML_URL_TO_CREATE_NEW_ISSUE,
                    KotlinCodeSmellDetectorBundle.message("report.error.connection.failure",
